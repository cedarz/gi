...
### 5. 双向路径追踪(Bidirectional Path Tracing, BDPT)
**学习目标**: 理解双向采样的优势
...
### 9. 辐照度环境映射(Irradiance Environment Mapping)
**学习目标**: 理解球谐函数在GI中的应用
...
### 10. 预计算辐射传输(Precomputed Radiance Transfer, PRT)
**学习目标**: 掌握低频GI的预计算方法
...
### 11. 反射阴影图(Reflective Shadow Maps, RSM)
...
### 12. 光照传播体积(Light Propagation Volumes, LPV)
