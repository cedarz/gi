...
![立体角示意图](https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Steradian.svg/400px-Steradian.svg.png)
> 图片来源: Wikipedia - Solid Angle
...
![辐射量关系图](https://pbr-book.org/3ed-2018/Color_and_Radiometry/Radiometric%20quantities.svg)
> 图片来源: PBRT Book - Radiometric Quantities Relationship

**推荐可视化工具**:
- 🎨 [Radiometry Visualizer](https://www.scratchapixel.com/lessons/3d-basic-rendering/introduction-to-shading/shading-lights)
- 📊 [Interactive Light Simulation](https://phet.colorado.edu/en/simulation/bending-light)
...
![Radiance定义示意图](https://www.pbr-book.org/3ed-2018/Color_and_Radiometry/Radiance%20geometry.svg)
> 图片来源: PBRT Book - Radiance Geometry
...
![BRDF可视化](https://www.pbr-book.org/3ed-2018/Reflection_Models/BRDF%20coordinate%20system.svg)
> 图片来源: PBRT Book - BRDF Coordinate System

**BRDF可视化资源**:
- 🎨 [Disney BRDF Explorer](https://github.com/wdas/brdf) - 迪士尼开源的BRDF查看器
- 📊 [MERL BRDF Database](https://www.merl.com/brdf/) - 100种真实材质的测量BRDF数据
- 🌐 [BRDF在线可视化](https://www.doerwalter.de/brdf/) - 交互式BRDF查看器
